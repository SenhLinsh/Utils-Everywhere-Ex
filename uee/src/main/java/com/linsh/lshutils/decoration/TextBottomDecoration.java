 ...
 * </pre>
 */
public class TextBottomDecoration extends RecyclerView.ItemDecoration {
    ...
    public TextBottomDecoration(@NonNull CharSequence text) {
        this(text, -1);
    }

    public TextBottomDecoration(@NonNull CharSequence text, int height) {
        this(text, new TextPaint(), height, -1);
        mTextPaint.setTextSize(UnitConverseUtils.sp2px(18));
    }

    public TextBottomDecoration(@NonNull CharSequence text, @NonNull TextPaint textPaint, int height, int width) {
        mText = text;
