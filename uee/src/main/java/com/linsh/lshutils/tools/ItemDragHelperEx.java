 ...
 * </pre>
 */
public class ItemDragHelperEx extends ItemTouchHelper {

    /**
     * 使用接口模式, 可以通过 Adapter 实现 IItemDragCallback 接口来让其在Adapter内部进行处理
     */
    public ItemDragHelperEx(IItemDragCallback callback) {
     ...
     */
    public ItemDragHelperEx(ItemDragCallback callback) {
        super(callback);
    }
