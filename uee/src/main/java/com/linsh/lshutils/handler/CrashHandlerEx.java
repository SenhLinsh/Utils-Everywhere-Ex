 ...
 * </pre>
 */
public abstract class CrashHandlerEx {

    private static final String KEY_LASTED_CRASH = "key_lasted_crash";
    private static CrashHandlerEx mHandler;
    ...
    public static void install(Application application, CrashHandlerEx handler) {
        if (mHandler != null) {
            return;
        }
        mHandler = handler;
        Thread.UncaughtExceptionHandler oldHandler = Thread.getDefaultUncaughtExceptionHandler();
        if (handler != null && !handler.getClass().getName().equals(CrashHandlerEx.class.getName())) {
