 ...
 * </pre>
 */
public abstract class ExpandableRcvAdapterEx<F, S> extends RecyclerView.Adapter implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void setData(List<F> firstLevelData, int expandedPosition, boolean notifyDataSetChanged) {
