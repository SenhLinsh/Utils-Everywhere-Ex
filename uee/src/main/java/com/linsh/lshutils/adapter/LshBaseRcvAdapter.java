 ...
 */
public abstract class LshBaseRcvAdapter<T, H extends LshViewHolder> extends BaseRcvAdapter<H>
    ...
    public void onClick(View v) {
        ...
        if (params instanceof RecyclerView.LayoutParams) {
            ...
            if (tag instanceof LshViewHolder) {
                LshViewHolder holder = (LshViewHolder) tag;
    ...
    public interface OnItemClickListener {
        void onItemClick(LshViewHolder holder, int position);
    }
    ...
    public interface OnItemLongClickListener {
        boolean onItemLongClick(LshViewHolder holder, int position);
    }
}
