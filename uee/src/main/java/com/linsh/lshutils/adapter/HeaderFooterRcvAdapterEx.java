 ...
 * </pre>
 */
public abstract class HeaderFooterRcvAdapterEx<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder>
    ...
    public HeaderFooterRcvAdapterEx(boolean hasHeader, boolean hasFooter) {
    ...
    protected abstract void onBindItemViewHolder(RecyclerView.ViewHolder holder, T t, int position);

    protected abstract void onBindHeaderViewHolder(RecyclerView.ViewHolder holder);

    protected abstract void onBindFooterViewHolder(RecyclerView.ViewHolder holder);
