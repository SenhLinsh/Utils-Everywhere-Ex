 ...
 * </pre>
 */
public class PropertiesFileUtilsEx {

    /**
     * 获取配置文件所处文件夹
     */
    private static File getPropertyDir() {
        return FileManagerUtilsEx.getDir("properties");
    }
    ...
    public static <T extends JsonBean> File getPropertyFile(Class<T> classOfT) {
        return FileManagerUtilsEx.getFile(getPropertyDir(), classOfT.getSimpleName());
    }
    ...
    public static File getPropertyFile(String fileName) {
        return FileManagerUtilsEx.getFile(getPropertyDir(), fileName);
    }
    ...
    public static <T extends JsonBean> T getObject(Class<T> classOfT) {
        ...
        try {
            ...
            Log.w("PropertiesFileUtilsEx", "解析Json出错");
        }
        return t;
    }
